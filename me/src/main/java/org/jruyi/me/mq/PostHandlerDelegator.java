...
final class PostHandlerDelegator implements IPostHandler {

	private final IServiceHolder<IPostHandler> m_holder;

	PostHandlerDelegator(IServiceHolder<IPostHandler> holder) {
		m_holder = holder;
	}
