...
public final class SslFilter implements IFilter<IBuffer, IBuffer> {
	...
	@Reference(name = "sslcp", policyOption = ReferencePolicyOption.GREEDY, bind = "bindSslContextParameters", unbind = "unbindSslContextParameters", updated = "updatedSslContextParameters")
